...
from models import db, Admin, Product, Address, Order, OrderOTP, User
...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'postgresql://postgres:divya%4004@localhost:5432/supermarket')
